...
/* I made changes to the original. If you base anything on this version, remember to
   include my CC license, too.
*/
...
/* Type */
	...
	h1 {
		...
		h1.major {
			...
			h1.major:after {
				background-image: -moz-linear-gradient(to right, #00001a, #660000);
				background-image: -webkit-linear-gradient(to right, #00001a, #660000);
				background-image: -ms-linear-gradient(to right, #00001a, #660000);
				background-image: linear-gradient(to right, #00001a, #660000);
