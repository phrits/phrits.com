...
<?php
    ...
    description("Tasty, easy, and versatile chocolate cake made with no eggs");
    html_meta(array("keywords"      => "Recipe"));
    html_meta(array("keywords"      => "vegetarian, vegan"));
    html_simple("title", "Crazy Cake - phrits.com")->output();
?>
    </head>
    <body>
...
<?php
    ...
    include($www . "/recipes/parts/part_crazy_cake.php");
