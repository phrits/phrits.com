...
<?php
    ...
    description("French fried onions from scratch");
    html_meta(array("keywords"      => "Recipe"));
    html_meta(array("keywords"      => "vegetarian, vegan"));
    html_simple("title", "French-Fried Onions - phrits.com")->output();
?>
    </head>
    <body>
...
<?php
    ...
    include($www . "/recipes/parts/part_french_fried_onions.php");
