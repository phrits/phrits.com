...
<?php
    ...
    description("Real, healthful food out of your microwave at work");
    html_meta(array("keywords"      => "Recipe"));
    html_simple("title", "Microwave Lunch - phrits.com")->output();
?>
    </head>
    <body>
...
<?php
    ...
    include($www . "/recipes/parts/part_microwave_lunch.php");
